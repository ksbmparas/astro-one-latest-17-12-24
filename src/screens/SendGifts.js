...
const SendGifts = () => {
    ...
    const renderitem = ({ item }) => {
        return (
            ...
            <TouchableOpacity style={{ width: SCREEN_WIDTH * 0.4, height: SCREEN_HEIGHT * 0.22 , alignItems: "center", paddingVertical: SCREEN_HEIGHT * 0.02, backgroundColor: "#FBE8E1", borderRadius: 10, elevation: 5 ,margin:SCREEN_HEIGHT*0.018}}>
                <Image
