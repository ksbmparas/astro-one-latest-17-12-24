...
const AstrologerDetailes = ({
  ...
  function ProfessionalGallery() {
    ...
    const Data = [
      ...
      { id: '3', image: require('../../assets/images/thetower.png') },
    ];
    ...
    return (
      <View style={{ paddingHorizontal: SCREEN_WIDTH * 0.02 ,backgroundColor:"white"}}>
  ...
  function chatCallPriceInfo() {
    ...
    return <View style={{ backgroundColor: Colors.white, }}>
      ...
      <View style={{ flexDirection: "row", gap: 13, paddingHorizontal: SCREEN_HEIGHT * 0.02 }}>
        ...
        <Text style={{ color: "black", fontSize: 13 }}>{showNumber(astroData?.call_price + parseFloat(astroData?.commission_call_price))}/min</Text>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          ...
          >
            ...
            <View style={{ alignItems: "center", justifyContent: "center", gap: 4 }}>
              ...
              <Text style={{ fontWeight: "700", fontSize: 12, color: "white" }}>{showNumber(astroData?.call_price + parseFloat(astroData?.commission_call_price))}</Text>
