...
const AstroForCall = ({ callListData, navigation, dispatch, isRefreshing, isMoreLoading }) => {
  ...
  //               }
  //               emptyStar={
  //                 <Ionicons name={'star-outline'} size={14} color={Colors.primaryLight} />
  //               }
  //               halfStar={
  //                 <Ionicons
  //                   size={14}
  ...
  //             borderRadius: 10,
  //           }}>
  //           <Ionicons name="call" color={colors.black_color} size={20} />
  //           <Text
  //             allowFontScaling={false}
  //             style={{
  //               fontSize: 14,
  ...
  return (
    ...
    <View style={{flexDirection:"row" ,gap:20 ,paddingHorizontal:SCREEN_WIDTH*0.035,paddingVertical:SCREEN_HEIGHT*0.02,backgroundColor: "#FFDBBB"}}>
        ...
        <View style={{left:SCREEN_WIDTH*0.05,}}> 
            ...
            <Text style={{fontSize:8,fontWeight:"500"}}>{item?.follower_count}  Followers</Text>
            <AntDesign name="clockcircleo" size={13}/>
            <Text style={{fontSize:8,fontWeight:"500"}}>{item.experience}  Year  Experience </Text>
