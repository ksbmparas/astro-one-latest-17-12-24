...
const Mahurat = () => {
  ...
  const Data2 = [
    { id: "1", name: 'yog', start: 'Grahpravesh', end: '8:20' },
  ...
  const Data3 = [
    { id: "1", name: 'yog', start: 'Vaahan', end: '7:20' },
  ...
  const Data4 = [
    { id: "1", name: 'yog', start: 'sampatti', end: '8:20' },
