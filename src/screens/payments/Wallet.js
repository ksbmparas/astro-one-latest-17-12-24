        ...
        <View style={{  marginTop: 5, }}>
          ...
          <View
            style={{
              ...
              alignItems: 'center',
              marginBottom: 15,
              backgroundColor:"white",paddingBottom:SCREEN_HEIGHT*0.05
            }}>


              <View style={{paddingBottom:SCREEN_HEIGHT*0.02}}>
                <Text style={{color:colors.background_theme2,fontWeight:"500"}}>Add Money to your Wallet</Text>
              </View>
            ...
            <Input
              ...
              inputContainerStyle={{ borderBottomWidth: 1, borderBottomColor: colors.black_color8, width: '90%', alignSelf: 'center' }}
              leftIcon={<Text style={{ ...Fonts.black22RobotoMedium ,fontSize:18}}>₹ </Text>}
            ...
            <TouchableOpacity
              onPress={() => add_money()}
              style={{ color: 'black', backgroundColor: colors.background_theme2, padding: 9, borderRadius: 20,width:'50%' ,alignItems:"center"}}
              activeOpacity={0.8}>
              <Text allowFontScaling={false} style={{ color: 'white', fontSize: getFontSize(1.6) }}>{t('Add')}</Text>
            </TouchableOpacity>
