...
import * as SettingActions from '../../redux/actions/SettingActions'
import { connect } from 'react-redux';
import PreviousKundli from './PreviousKundli';
import EnterKundli from './EnterKundli';
...
const NewMatching = props => {
  ...
  return (
    ...
    >
      <Tab.Screen name="enterKundli" component={EnterKundli} />
      <Tab.Screen name="prevKundli" component={PreviousKundli} />
    </Tab.Navigator>
  );
};
...
export default connect(null, mapDispatchToProps)(NewMatching);
