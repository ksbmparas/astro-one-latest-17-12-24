  ...
  function Logos(){
    return(
      <View style={{paddingHorizontal:SCREEN_WIDTH*0.02}}>
                <View style={{flexDirection:"row" ,justifyContent:"space-evenly",paddingVertical:SCREEN_HEIGHT*0.02}}>
                         < Image 
                         style={{height:SCREEN_HEIGHT*0.06,width:SCREEN_WIDTH*0.13,borderRadius:100}}
