...
const CustomerAccount = props => {
  ...
  const validation1 = () => {
    if (profileImage === ' https://astrooneapi.ksdelhi.net/uploads/customerImage/user_default.jpg') {
            ...
            {/* // )} */}
              ...
              <TouchableOpacity
                ...
                <Text allowFontScaling={false}
                  style={{
                    ...
                    color: colors.black_color9,
                    fontWeight: 'normal',
                    fontSize: getFontSize(1.4), paddingVertical:SCREEN_HEIGHT*0.017
                  }}>
                  {time == null
                    ? t("time_of_birth")
              ...
              <TouchableOpacity
                ...
                <MaterialCommunityIcons
                  ...
                  size={25}
                />
                <Text allowFontScaling={false} style={{ fontSize: getFontSize(1.4), color: colors.black_color, paddingVertical:SCREEN_HEIGHT*0.017 }}>
