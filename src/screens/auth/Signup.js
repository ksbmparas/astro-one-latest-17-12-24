...
import DateTimePiPIcker from '@react-native-community/datetimepicker';
    ...
    <View style={{ flex: 1, backgroundColor: colors.background_theme1 }}>
      <ScrollView>
        <View style={{gap:14}}>
                ...
                <TouchableOpacity 
                onPress={() => go_home()}
                style={{alignItems:"flex-end",paddingHorizontal:SCREEN_WIDTH*0.07,paddingTop:SCREEN_HEIGHT*0.01}}>
                  <Text style={{fontSize:16 ,color:colors.background_theme2,textDecorationLine:"underline"}}>Skip</Text>
                </TouchableOpacity>

                <View style={{flexDirection:"row" ,alignItems:"center" ,gap:10 ,paddingHorizontal:SCREEN_WIDTH*0.03,}}>
                  <Text style={{...Fonts.SourGummyItalic}}>Welcome</Text>

                  <Image 
                  style={{height:SCREEN_HEIGHT*0.03,width:SCREEN_WIDTH*0.06}}
                  source={require('../../assets/images/nasmte.png')}/>
                ...
                <Text style={{...Fonts.SourGummyRegular}}>We happy to see you here. To use your account you should regiter first .</Text>
